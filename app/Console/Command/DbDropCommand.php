...
class DbDropCommand extends \Symfony\Component\Console\Command\Command implements CompletionAwareInterface
{
    use Command;
    ...
    public function fire()
    {
        ...
        return $this->getHelper('database')->dropDatabase($database, $this->output);
    }
